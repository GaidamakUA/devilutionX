...
const char *const CREDITS_LINES[] = {
	...
	"",
	"Художні директори відеовставок",
	...
	"",
	"Музика і звук відеовставок",
	"	Glenn Stafford, Matt Uelmen",
	"",
	"Звукове виробництво, управління та відбір акторів",
	...
	"",
	"",
	"	Жодна жива душа не була продана в процесі створення гри.",
	"",
	"",
	" ",
	" ",
